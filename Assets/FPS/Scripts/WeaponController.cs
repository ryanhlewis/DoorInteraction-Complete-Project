...
public class WeaponController : MonoBehaviour
{
    ...
    void HandleShoot()
    {
        ...
        for (int i = 0; i < bulletsPerShotFinal; i++)
        {
            ...
            //GameObject ball = Instantiate(bullet);
            GameObject bullett = Instantiate(bullet,weaponMuzzle.position,weaponMuzzle.rotation);
            //Collider m_Collider = bullett.AddComponent<SphereCollider> ();
            //Rigidbody rb = bullett.AddComponent<Rigidbody>();
